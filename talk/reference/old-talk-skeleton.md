> ⚠️ **SUPERSEDED — reference material only.** This is the v1 skeleton (recovered from git,
> commit `972b4f0`, deleted 2026-07-07). Costa judged it not good enough and we are building a
> **new** deck from scratch in `../slides.md`. Do NOT restore or follow this structure. Mine it
> for raw material: the war stories, the code references (`file:line`), the asset shot list, and
> the "topic reservoir" catalog at the bottom are all still accurate against the codebase.
