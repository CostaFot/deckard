...
import com.costafotiadis.deckard.accessibility.extract.ScreenContentExtractors
import com.costafotiadis.deckard.accessibility.tree.ScreenNode
import com.costafotiadis.deckard.accessibility.tree.ScreenNodeSnapshot
import com.costafotiadis.deckard.accessibility.tree.toDebugString
 ...
 *    (the in-use screen reader, [com.costafotiadis.deckard.slop.AccessibilityScreenTextReader],
 *    pulls it when Deckard is summoned).
 * 2. **Screenshots** — registers [ScreenshotCapturer]'s handler for the fallback OCR reader
 *    ([com.costafotiadis.deckard.slop.OcrScreenTextReader], which asks for a JPEG of the display).
 *
